...
def getPavementType(img, model_path):
    ...
    im = torch.Tensor(preprocessed).to(model.device)
...
def assessRouteSegment(route_segment_image_path, route_segment_lat, route_segment_lon):
    ...
    pavementType = getPavementType(img, pavement_type_model_path)
...
#assessRouteSegment(r'C:\Projetos\Mestrado\masters_thesis\survey\SurveyApp\SurveyApp\wwwroot\img\segment24.jpg', 38.7098603, -9.1482613)
